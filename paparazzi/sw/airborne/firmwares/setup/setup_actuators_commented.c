...
#include "std.h" 				// some standard C libraries
#include "mcu.h" 				// make sure mcu is initialized
#include "mcu_periph/sys_time.h"
#include "led.h"
#include "firmwares/fixedwing/actuators.h"
//#include "actuators.h"

#include "firmwares/fixedwing/main_fbw.h"	// fly by wire modes
...
void init_fbw( void ) {
  ...
  /*******************************
  * SERVOS_NB = 8
  * Initializes all servos to 1500 (neutral between 1000 and 2000)?
  ********************************/
  uint8_t i;
  ...
  mcu_int_enable();  // interrupt enable
}

/*****************************************
* Check connection to paparazzi every 300 __
******************************************/
